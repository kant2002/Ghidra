...
<!-- HelpSet auto-generated on Thu Feb 28 12:48:37 EST 2019 -->
<helpset version="2.0">
	<title>Base HelpSet</title>
	<maps>
		<mapref location="Base_map.xml" />
	</maps>
	<view mergetype="javax.help.UniteAppendMerge">
		<name>TOC</name>
		<label>Ghidra Table of Contents</label>
		<type>docking.help.CustomTOCView</type>
		<data>Base_TOC.xml</data>
	</view>
	<view>
		<name>Search</name>
		<label>Search for Keywords</label>
		<type>docking.help.CustomSearchView</type>
		<data engine="com.sun.java.help.search.DefaultSearchEngine">Base_JavaHelpSearch</data>
	</view>
	<view>
		<name>Favorites</name>
